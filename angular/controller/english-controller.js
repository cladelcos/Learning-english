english.controller("generalCtrl", function ($scope) {
	...
	$scope.lyric = [{band: bandName("lpftbr"), coverAlbum: cover("lp", "brwmi"), songName: "We Made It", url: "https://genius.com/Busta-rhymes-we-made-it-lyrics"},
					{band: bandName("lp"), coverAlbum: cover("lp", "blackbirds"), songName: "Blackbirds", url: "https://www.azlyrics.com/lyrics/linkinpark/blackbirds.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "htep"), songName: "Carousel", url: "https://www.azlyrics.com/lyrics/linkinpark/carousel.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "htep"), songName: "High Voltage", url: "https://www.azlyrics.com/lyrics/linkinpark/highvoltage.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ht"), songName: "Papercut", url: "https://www.azlyrics.com/lyrics/linkinpark/papercut.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ht"), songName: "One Step Closer", url: "https://www.azlyrics.com/lyrics/linkinpark/onestepcloser.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ht"), songName: "With You", url: "https://www.azlyrics.com/lyrics/linkinpark/withyou.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ht"), songName: "Points Of Authority", url: "https://www.azlyrics.com/lyrics/linkinpark/pointsofauthority.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ht"), songName: "Crawling", url: "https://www.azlyrics.com/lyrics/linkinpark/crawling.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ht"), songName: "Runaway", url: "https://www.azlyrics.com/lyrics/linkinpark/runaway.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ht"), songName: "By Myself", url: "https://www.azlyrics.com/lyrics/linkinpark/bymyself.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ht"), songName: "In The End", url: "https://www.azlyrics.com/lyrics/linkinpark/intheend.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ht"), songName: "A Place For My Head", url: "https://www.azlyrics.com/lyrics/linkinpark/aplaceformyhead.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ht"), songName: "Forgotten", url: "https://www.azlyrics.com/lyrics/linkinpark/forgotten.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ht"), songName: "Cure For The Itch", url: "https://www.azlyrics.com/lyrics/linkinpark/curefortheitch.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ht"), songName: "Pushing Me Away", url: "https://www.azlyrics.com/lyrics/linkinpark/pushingmeaway.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "meteora"), songName: "Don't Stay", url: "https://www.azlyrics.com/lyrics/linkinpark/dontstay.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "meteora"), songName: "Somewhere I Belong", url: "https://www.azlyrics.com/lyrics/linkinpark/somewhereibelong.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "meteora"), songName: "Lying From You", url: "https://www.azlyrics.com/lyrics/linkinpark/lyingfromyou.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "meteora"), songName: "Hit The Floor", url: "https://www.azlyrics.com/lyrics/linkinpark/hitthefloor.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "meteora"), songName: "Easier To Run", url: "https://www.azlyrics.com/lyrics/linkinpark/easiertorun.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "meteora"), songName: "Faint", url: "https://www.azlyrics.com/lyrics/linkinpark/faint.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "meteora"), songName: "Figure.09", url: "https://www.azlyrics.com/lyrics/linkinpark/figure09.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "meteora"), songName: "Breaking The Habit", url: "https://www.azlyrics.com/lyrics/linkinpark/breakingthehabit.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "meteora"), songName: "From The Inside", url: "https://www.azlyrics.com/lyrics/linkinpark/fromtheinside.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "meteora"), songName: "Nobody's Listening", url: "https://genius.com/Linkin-park-nobodys-listening-lyrics"},
					{band: bandName("lp"), coverAlbum: cover("lp", "meteora"), songName: "Session", url: "http://www.metrolyrics.com/session-lyrics-linkin-park.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "meteora"), songName: "Numb", url: "https://www.azlyrics.com/lyrics/linkinpark/numb.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "mtm"), songName: "Leave Out All The Rest", url: "https://www.azlyrics.com/lyrics/linkinpark/leaveoutalltherest.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "mtm"), songName: "Bleed It Out", url: "https://www.azlyrics.com/lyrics/linkinpark/bleeditout.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "mtm"), songName: "Shadow Of The Day", url: "https://www.azlyrics.com/lyrics/linkinpark/shadowoftheday.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "mtm"), songName: "What I've Done", url: "https://www.azlyrics.com/lyrics/linkinpark/whativedone.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "mtm"), songName: "No More Sorrow", url: "https://www.azlyrics.com/lyrics/linkinpark/nomoresorrow.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "mtm"), songName: "Valentine's Day", url: "https://www.azlyrics.com/lyrics/linkinpark/valentinesday.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ats"), songName: "Waiting For The End", url: "https://www.azlyrics.com/lyrics/linkinpark/waitingfortheend.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ats"), songName: "Blackout", url: "https://www.azlyrics.com/lyrics/linkinpark/blackout.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ats"), songName: "Wretches And Kings", url: "https://www.azlyrics.com/lyrics/linkinpark/wretchesandkings.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ats"), songName: "Wisdom, Justice And Love", url: "https://www.azlyrics.com/lyrics/linkinpark/wisdomjusticeandlove.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ats"), songName: "Iridescent", url: "https://www.azlyrics.com/lyrics/linkinpark/iridescent.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ats"), songName: "Fallout", url: "https://www.azlyrics.com/lyrics/linkinpark/fallout.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "ats"), songName: "The Catalyst", url: "https://www.azlyrics.com/lyrics/linkinpark/thecatalyst.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "lt"), songName: "Burn It Down", url: "https://www.azlyrics.com/lyrics/linkinpark/burnitdown.html"},
					// {band: bandName("lp"), coverAlbum: cover("lp", "thp"), songName: "Keys To The Kingdom", url: ""},
					// {band: bandName("lp"), coverAlbum: cover("lp", "thp"), songName: "All For Nothing", url: ""},
					{band: bandName("lp"), coverAlbum: cover("lp", "thp"), songName: "Guilty All The Same", url: "https://genius.com/Linkin-park-guilty-all-the-same-lyrics"},
					// {band: bandName("lp"), coverAlbum: cover("lp", "thp"), songName: "The Summoning", url: ""},
					// {band: bandName("lp"), coverAlbum: cover("lp", "thp"), songName: "War", url: ""},
					// {band: bandName("lp"), coverAlbum: cover("lp", "thp"), songName: "Wastelands", url: ""},
					// {band: bandName("lp"), coverAlbum: cover("lp", "thp"), songName: "Until It's Gone", url: ""},
					// {band: bandName("lp"), coverAlbum: cover("lp", "thp"), songName: "Rebellion", url: ""},
					// {band: bandName("lp"), coverAlbum: cover("lp", "thp"), songName: "Mark The Graves", url: ""},
					// {band: bandName("lp"), coverAlbum: cover("lp", "thp"), songName: "Drawbar", url: ""},
					{band: bandName("lp"), coverAlbum: cover("lp", "thp"), songName: "Final Masquerade", url: "https://www.azlyrics.com/lyrics/linkinpark/finalmasquerade.html"},
					// {band: bandName("lp"), coverAlbum: cover("lp", "thp"), songName: "A Line In The Sand", url: ""},
					{band: bandName("lp"), coverAlbum: cover("lp", "oml"), songName: "Nobody Can Save Me", url: "https://www.azlyrics.com/lyrics/linkinpark/nobodycansaveme.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "oml"), songName: "Good Goodbye", url: "https://genius.com/Linkin-park-good-goodbye-lyrics"},
					{band: bandName("lp"), coverAlbum: cover("lp", "oml"), songName: "Talking To Myself", url: "https://genius.com/Linkin-park-talking-to-myself-lyrics"},
					{band: bandName("lp"), coverAlbum: cover("lp", "oml"), songName: "Battle Symphony", url: "https://www.azlyrics.com/lyrics/linkinpark/battlesymphony.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "oml"), songName: "Invisible", url: "https://www.azlyrics.com/lyrics/linkinpark/invisible.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "oml"), songName: "Heavy", url: "https://genius.com/Linkin-park-heavy-lyrics"},
					{band: bandName("lp"), coverAlbum: cover("lp", "oml"), songName: "Sorry for Now", url: "https://www.azlyrics.com/lyrics/linkinpark/sorryfornow.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "oml"), songName: "Halfway Right", url: "https://lyricsfa.com/2017/03/13/linkin-park-halfway-right-lyrics/"},
					{band: bandName("lp"), coverAlbum: cover("lp", "oml"), songName: "One More Light", url: "https://www.azlyrics.com/lyrics/linkinpark/onemorelight.html"},
					{band: bandName("lp"), coverAlbum: cover("lp", "oml"), songName: "Sharp Edges", url: "https://www.azlyrics.com/lyrics/linkinpark/sharpedges.html"},
					{band: bandName("fm"), coverAlbum: cover("fm", "trt"), songName: "Believe Me", url: "https://www.azlyrics.com/lyrics/fortminor/believeme.html"},
					{band: bandName("fm"), coverAlbum: cover("fm", "trt"), songName: "Where'd You Go", url: "https://www.azlyrics.com/lyrics/fortminor/wheredyougo.html"},
					{band: bandName("audio"), coverAlbum: cover("audioslave", "audioslave"), songName: "Discograph Complete", url: "http://www.taringa.net/comunidades/linkinparktaringa/7314323/Fort-Minor-Discografia-MediaFire-320-Kbps.html"},
					{band: bandName("audio"), coverAlbum: cover("audioslave", "audioslave"), songName: "Like a Stone", url: "https://www.azlyrics.com/lyrics/audioslave/likeastone.html"},
					// {band: bandName("lp"), coverAlbum: cover("lp", ""), songName: "", url: ""}
					];
